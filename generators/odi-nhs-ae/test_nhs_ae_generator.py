...
def test_generator():
    ...
    with open(os.path.join(os.getcwd(), "generators", "odi-nhs-ae", "test-data", "test_reference.csv")) as r, \
            open(os.path.join(os.getcwd(), "generators", "odi-nhs-ae", "test-data", "test_generated.csv")) as f:
...
def test_deidentify():
    ...
    with open(os.path.join(os.getcwd(), "generators", "odi-nhs-ae", "test-data", "test_deidentify_reference.csv")) as r, \
            open(os.path.join(os.getcwd(), "generators", "odi-nhs-ae", "test-data", "test_deidentify.csv")) as f:
        reader_r = csv.reader(r)
        reader_f = csv.reader(f)
